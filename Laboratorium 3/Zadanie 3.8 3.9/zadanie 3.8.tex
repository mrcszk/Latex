...
\begin{tabular}{||c|c||c|c||}
	...
	&&\includegraphics[scale=0.17]{kruk}&\includegraphics[scale=0.17]{bazant-lowny}\\		 \midrule\hline
	&&\includegraphics[scale=0.2]{bazant-lowny}&\\		\hline
	\includegraphics[scale=0.2]{jaskolka-oknowka}&&&\includegraphics[scale=0.19]{kuropatwa}\\	\hline
	\bottomrule
\end{tabular}
