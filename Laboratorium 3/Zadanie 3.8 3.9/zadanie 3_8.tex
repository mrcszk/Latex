...
\usepackage{makecell}
\marginsize{4.5cm}{4.5cm}{2.5cm}{2.5cm}
\sloppy
...
\begin{tabular}{||c|c||c|c||}
	\toprule
	\toprule
	\includegraphics[scale=0.2]{kuropatwa}&\includegraphics[scale=0.2]{kruk}&&	\\\hline
	&&\makecell{ \\ \includegraphics[scale=0.17]{kruk}}&\makecell{\\ \includegraphics[scale=0.17]{bazant-lowny}} \\		 \midrule\hline
	&&\makecell{\\ \includegraphics[scale=0.2]{bazant-lowny}}&\\		\hline
	\makecell{\\ \includegraphics[scale=0.2]{jaskolka-oknowka}}&&&\makecell{ \\ \includegraphics[scale=0.19]{kuropatwa}}\\	\hline
	\bottomrule
\end{tabular}
	\caption{Sudoku obrazkowe 2x2}	
	\label{fig:sudoku}
\end{figure}
